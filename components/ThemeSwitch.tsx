...
const Sun = () => (
  <svg
    ...
    viewBox="0 0 20 20"
    fill="currentColor"
    className="group:hover:text-neutral-100 h-6 w-6"
  >
  ...
  return (
    <div className="mr-5 flex items-center">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <MenuItems className="absolute right-0 z-50 mt-2 w-32 origin-top-right divide-y divide-neutral-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-neutral-700">
